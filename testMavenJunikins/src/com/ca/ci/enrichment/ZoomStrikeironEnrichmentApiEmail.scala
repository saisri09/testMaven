  ...
  */
  ...
  def main(arg: Array[String]) = {
    ...
    */
    ...
    val instanceName="Zoom_Strikeiron_EnrichmentApiEmail_load_"+System.currentTimeMillis()
  ...
  def processRecords(sparkSession: SparkSession,ruleMap:scala.collection.mutable.Map[String, String],jdbcURL:String,connectionProperties:Properties): Unit = {
    ...
    try {
      ...
      */
      ...
      val dbEmailRunfilter = sparkSession.sql("select * from Zoom_Strikeiron_EnrichmentApiEmail_Temp_View where updated_date like'" + currentDate + "%'")
