...
object ZoomInfoEnrichment {

  val appname = "Zoom_Info_Enrichment"
  val started = "started"
  val ended = "ended"
  /*
  map for config file
  ...
  */
  def main(arg: Array[String]) = {
    ...
    */
    ...
    val file_key=1
    val instanceName="Zoom_Info_Enrichment_Load_"+System.currentTimeMillis()
  ...
  def processRecords(sparkSession: SparkSession,ruleMap:scala.collection.mutable.Map[String, String],jdbcURL:String,connectionProperties:Properties) {
     ...
     */
      ...
      /*
       load person table
      */
      //val dbPerson = sparkSession.read.jdbc(jdbcURL, "mdm.person", connectionProperties).select("person_key", "source_system_person_id", "first_name", "last_name","updated_date")
      /*
      ...
      */
      ...
      /*
      join dbBatchRunDetails and person table on source_system_person_id
       */
      //val PersonRunDetailDF=dbBatchRunDetails.join(dbPerson,"source_system_person_id")
      //print("PersonRunDetailDF"+PersonRunDetailDF.show())
      ...
      val dbPersonRunfilter = sparkSession.sql("select * from PersonRunDetailDF_Temp_Table where person_updated_date like'" + currentDate + "%'")
      ...
      */
      ...
      invokeAPIWithThrottling(recordToFireList,access_key,secret_key,zoominfoPersonMatchUrl,zoominfoPersonMatchHost,zoominfoPersonMatchcanonicaluri,throttlingFactorPersonMatch,timeToWaitInsecondPersonMatch)
      ...
      */
      ...
      //print("Numner of records to fire detail" )
