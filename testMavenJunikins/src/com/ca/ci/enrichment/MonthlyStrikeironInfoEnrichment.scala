  ...
  */
  def main(arg: Array[String]) = {
    ...
    /* val sparkConf = new SparkConf().setAppName(appname).setMaster("local")
     val sparkContext = new SparkContext(sparkConf)
     val sparkSession = SparkSession.builder.appName("MonthlyStrikeironInfoEnrichment").config("spark.sql.warehouse.dir","file:///C:/tempwarehouse").getOrCreate()
    */
    ...
    */
    ...
    val instanceName="Monthly_Strikeiron_InfoEnrichment_load_"+System.currentTimeMillis()
  ...
  def processRecords(sparkSession: SparkSession,ruleMap:scala.collection.mutable.Map[String, String],jdbcURL:String,connectionProperties:Properties,userName:String): Unit = {
    ...
    try {
      ...
      */
       ...
       */
      val dbBatchRunDetails = sparkSession.read.jdbc(jdbcURL, "mdm.monthly_strikeiron_vw", connectionProperties).select("person_email_key")
      ...
      */
      ...
      val dbPersonRunfilter = sparkSession.sql("select * from filterBatchRunViewEmail where updated_date like'" + currentMonth + "%'")
