...
/**
  ...
  */
object MonthlyZoomMelissaEnrichmentApiPhone {
  /*
  ...
  val appname = "MonthlyZoomMelissaEnrichmentApiPhone"
  ...
  def main(arg: Array[String]) = {
    ...
    val sparkContext = new SparkContext(sparkConf)
    val sparkSession = SparkSession.builder.appName("MonthlyZoomMelissaEnrichmentApiPhone").config("spark.sql.warehouse.dir","file:///C:/tempwarehouse").getOrCreate()
    */
    ...
    */
    ...
    val file_key=1
    val instanceName="Monthly_ZoomMelissa_Enrichment_ApiPhone_load_"+System.currentTimeMillis()
  ...
  def processRecords(sparkSession: SparkSession,ruleMap:scala.collection.mutable.Map[String, String],jdbcURL:String,connectionProperties:Properties): Unit = {
     ...
     */
       ...
       */
       ...
       val dbPhoneRunfilter = sparkSession.sql("select * from Zoom_MelissaEnrichmentApi_Phone_Temp_View where updated_date like'" + currentMonth + "%'")
